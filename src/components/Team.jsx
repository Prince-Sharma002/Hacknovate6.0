...
const Team = () => {
      ...
      <div className="team-wrapper">
        <div className="container flex flex-col lg:flex-row gap-4">
          <div className="left-container flex-1">
            <div className="title-container flex items-center font-serif font-bold">
              <span className="title-highlight text-yellow-400 text-8xl">O</span>
              <h1 className="title-text text-black text-6xl">ur Team</h1>
            </div>
            <div className="image-section w-full text-center text-gray-700 text-lg font-bold mb-4">
            ...
            <div className="final-box-container flex flex-col md:flex-row gap-4">
              <div className="final-box w-full md:w-1/2 text-center text-gray-700 font-bold">
  ...
  <h4>The "Remus Lupin and Ginny Weasley" duoRemus brings thoughtful, strategic designs as sharp as a werewolf’s instincts, while Ginny adds flair and precision, making everything as vibrant as a Quidditch match.</h4>
          ...
          <div className="right-container flex-1">
            ...
            <div className="image-section2 w-full text-center text-gray-700 font-bold">
              <img src={techteam} alt="techteam" className="w-full h-auto text-justify leading-[120px]" />
              <h4 className="text-justify leading-[23px]">Our Technical Team—a squad of five brilliant wizards—ensures every spell (or script) runs flawlessly! Led by the Dumbledore of Development, they craft magic behind the scenes. While Prince & Nikita weave spells of innovation, the rest of our tech sorcerers work as Marauders of Debugging, vanquishing bugs, Floo Network Engineers, keeping systems seamlessly connected, and Keepers of the Forbidden Code, guarding Hacknovate with security stronger than Gringotts! With enchanted code and spellbinding precision, they make Hacknovate truly magical!</h4>
            </div>
            <div className="final-box w-full text-center text-gray-700 font-bold">
        ...
        <div className="final-section flex flex-col md:flex-row gap-4 mt-6">
          <div className="final-box w-full md:w-1/2 text-center text-gray-700 font-bold">
          ...
          <div className="final-box2 w-full md:w-1/2 text-center text-gray-700 font-bold">
        ...
        <div className="final-section flex flex-col md:flex-row gap-4 mt-6">
          <div className="final-box w-full md:w-1/2 text-center text-gray-700 font-bold">
            <img src={vidhi} alt="Discord Team" className="w-full h-auto" />
            <h4>Like Ravenclaw’s brightest minds, this creative team blends wisdom and imagination to craft spellbinding content and enchanting designs. With the precision of McGonagall, the vision of Newt Scamander, and the flair of Tonks, they bring Hacknovate 6.0 to life with every stroke and story!.</h4>
          </div>
          <div className="final-box2 w-full md:w-1/2 text-center text-gray-700 font-bold">
            <img src={gringots} alt="Technical Team" className="w-full h-auto" />
