...
const About = () => {
  return (
    <div className="border-4 border-slate-800  w-full border-b-0 p-4 pb-0 mb-0">
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
        <div>
          <h1 className="text-xl md:text-4xl font-extrabold uppercase text-center mb-4">Hacknovate 6.0</h1>
        ...
        <div className="md:text-justify">
          ...
          <div className="col-span-2 md:w-164 h-164 md:col-span-1 flex ">
